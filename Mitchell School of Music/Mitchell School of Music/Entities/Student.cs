    ...
    class Student
    {
        ...
        public string ParentName
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidDataException("Parent name must be between 3 and 60 characters long.");
                }
            }
        }
        ...
        public string DateLeft
        {
            ...
            {
                //check and set if valid
                if (Utilities.ValidDate(value, DateTime.Now.Date, dateJoined.Date))
                {
                    dateLeft = DateTime.Parse(value);
                }
                else
                {
                    throw new InvalidDataException("Date left must be between either " + DateTime.Now.Date.ToString("dd/MM/yyyy)") + " and the date the person joined (" + dateJoined + ").");
                }
            }
        }
        ...
        public bool CurrentStudent
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidDataException("Input a value for whether this is a current student.");
                }
            }
        }
    }
